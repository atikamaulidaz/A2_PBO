        ...
        while (true) {
            ...
            switch(pilihan){
                ...
                case 5:
                    ...
                    @Override
                    void Berhasil() {
                        System.out.println("Andi, Pesananmu udah di jalan nih");
                        }
                    };
                    ...
                    @Override
                    void Berhasil() {
                        System.out.println("Andika, Pesananmu akan segera tiba");
                        }
                    };
                ...
                case 6:
                    ...
                    System.out.println("Minimal pembelian Rp45000 kamu dapat potongan sebesar Rp"+ Makanan.diskon(15000));
                    System.out.println("Minimal pembelian Rp80000 kamu dapat potongan sebesar Rp" + Makanan.diskon(15000, 5000));
                    System.out.println("Minimal pembelian Rp150000 kamu dapat potongan sebesar Rp" + Makanan.diskon(15000, 5000, 5000));
                    break;
